...
% با توجه به فایل نمونه از دستورات inpdic، indic و ingls برای اضافه کردن لغات به نمایه یا واژه‌نامه استفاده کنید.
...
\documentclass[phd,draftmode]{AlzahraThesis}
...
% در این بخش مشخصات پایان‌نامه به کلاس معرفی می‌شود. فایل specifications را مشابه نمونه داده شده و مطابق با رساله/پایان‌نامه خود ویرایش کنید.
